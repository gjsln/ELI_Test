...
module.exports = function(grunt) {
    ...
    var taskConfig = {
        ...
        jshint: {
            ...
            appPostConcat: ['release/script.js'],
        },
        concat: {
            options: {
                separator: '\n\n'
        ...
        less: {
            production: {
                options: {
                    ...
                    cleancss: true,
                    sourceMap: true,
                    sourceMapRootpath: 'release',
                    sourceMapURL: 'style.min.css.map',
                    sourceMapFilename: 'release/style.min.css.map'
                },
                files: {
                    'release/style.css': 'dev/less/style.less'
                }
            }
        },
        cssmin: {
            ...
            compress: {
                files: {
                    'release/style.min.css': ['release/style.css']
                }
            }
        },
        express: {
